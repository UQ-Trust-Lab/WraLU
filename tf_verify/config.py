...
class config:
    ...
    k = 0  # group size for k-activation relaxations
    s = 0  # sparsity parameter for k-activation relaxatin. Maximum overlap. Negative numbers compute s<-K+s. -2 is the default
    # Geometric options
    ...
    # GPU options
    device = Device.CPU  # Which device Deeppoly should run_cpu on
